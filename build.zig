...
pub fn build(b: *std.Build) void {
    ...
    addFileContainsCheckStep(b, file_contains_checker, test_step, "test-windows-gpu-packet-presenter", "Verify Windows uses retained Direct2D packets with recovery, bounded resources, and dirty-region pixel fallback", &.{
        ...
        .{ .path = "src/platform/windows/webview2_host.cpp", .pattern = "InvalidateRect(view.hwnd, info.has_dirty_rect ? &info.dirty_rect : nullptr, FALSE)" },
        ...
        .{ .path = "src/platform/windows/webview2_host.cpp", .pattern = "info.has_dirty_rect && !PtInRect(&info.dirty_rect, sample)" },
